...
// Implementation of the Frank Model Class for Simulations
 ...
 */
class Model_Sim : public franka::Model {
 public:
  /**
   ...
   */
  //Model_Sim(Model&& model) noexcept;
   ...
   */
  //Model_Sim& operator=(Model&& model) noexcept;
  ...
  //Model_Sim(const Model&) = delete;
  //Model_Sim& operator=(const Model&) = delete;
  /// @endcond
